...
def makeWithdrawal(info: list) -> list:
    # allows user to withdrawl money from accounts
    accType = selectAcc()
    while True:
        userChoice = int(input("How much would you like to withdrawl? "))
        if userChoice <= 0:
            print("You must withdrawl more than 0 dollars.")
        else:
            if accType == 1 and userChoice < info[2]:
                ...
                print("You must withdrawl within your account balance.")
